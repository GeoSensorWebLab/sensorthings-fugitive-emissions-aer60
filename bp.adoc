:Title: OGC Integrated Methane Sensor Web for Emissions Management Best Practice - Part I - Fugitive Emissions Management based on AER Directive 60
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/imsw-fm-aer60/1.0
|Internal reference number of this OGC(R) document:    21-070
|Version: 1.0
