...
image::figures/FIGn.002.jpg[SensorThings API Entities for the Fugitive Emissions AER 60 Best Practice]
...
image::figures/FIGn.003.png[Thing and FeatureOfInterest Relationship]
