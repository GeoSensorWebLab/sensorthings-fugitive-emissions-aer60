...
==== Requirement 1
This requirement defines the mandatory properties and relations of a reporting facility (as a Thing).
...
==== Requirement 14
This requirement defines the mandatory properties and relations of the "Sensor" entity. The "Sensor" entity in this best practice is not an instrument, but rather it SHALL be an observation process https://portal.ogc.org/files/?artifact_id=41579#page=20[[ISO/OGC 19156:2001 OM_Process]] describing the Fugitive Emissions Management Program (FEMP) that generates the observation result.
