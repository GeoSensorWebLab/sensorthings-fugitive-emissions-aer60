...
|*Requirement 12* {set:cellbgcolor:#CACCCE} |http://www.opengis.net/spec/sensorthings-fugitive-emissions-ab/1.0/req/datastream/number-of-fugitive-emissions-entity +
